...
var groupNewGrid = function (resource, restfulUrl, conditions) {
    this.resource = resource;
    this.restfulUrl = restfulUrl;
    if (conditions) {
        this.conditions = conditions;
...
groupNewGrid.prototype.query = function (conditions, callback) {
    var self = this;
    if (self.pageNumber) {
...
groupNewGrid.prototype.nextPage = function (callback) {
    if (this.conditions.pageNo < this.pageNumber) {
        this.conditions.pageNo++;
        this.query([], callback);
    }
};
groupNewGrid.prototype.prePage = function (callback) {
